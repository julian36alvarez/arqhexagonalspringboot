...
public class ValidadorArgumento {
    ...
    public static void validarFechaNoMenorHoy(LocalDateTime fechaProgramada, String mensaje){
    ...
    public static void validarHoraNoMayor(LocalDateTime fechaProgramada, String mensaje){
    ...
    public static void validarTipoServicio(Long idTipoServicio, String mensaje){
        ArrayList<Long> list = new ArrayList<>();
        list.add(1l);
        list.add(2l);
        list.add(3l);
        if ( !list.contains(idTipoServicio)) {
            throw new ExcepcionValorInvalido(mensaje);
        }
    }

    public static void validarTipoCliente(Long idTipoCliente, String mensaje){
        ArrayList<Long> list = new ArrayList<>();
        list.add(1l);
        list.add(2l);
        if ( !list.contains(idTipoCliente)) {
            throw new ExcepcionValorInvalido(mensaje);
        }
    }
